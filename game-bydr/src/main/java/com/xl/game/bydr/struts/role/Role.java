package com.xl.game.bydr.struts.role;
...
//	}
    ...
    public void changeGold(int gold, Reason reason) {
        IRoleScript roleScript = (IRoleScript) SpringUtil.getBean("roleGoldChange");
        roleScript.changeGold(this, gold, reason);
    }
    ...
    public void syncGold(Reason reason) {
        IRoleScript roleScript = (IRoleScript) SpringUtil.getBean("roleGoldChange");
        roleScript.syncGold(this, reason);
    }
